...
const DigitalBusinessCard = () => {
  ...
  const handleSaveContact = () => {
    const vcard = [
      ...
      "FN:Av. İsmail Karaca",
      "N:Karaca;İsmail;Av.;;",
      "ORG:Karaca Hukuk & Danışmanlık",
      "TITLE:Kurucu Avukat",
      "TEL;TYPE=CELL,VOICE;VALUE=uri:tel:+905337308053",
      "EMAIL;TYPE=PREF,INTERNET:avismailkaraca@gmail.com",
      "URL:https://rizeavukatkaraca.com",
      "ADR;TYPE=WORK,POSTAL,PARCEL:;;Çarşı Mah. Kazım Karabekir Cad. Kutlu Han Kat:3 No:407;Merkez;Rize;53100;Turkey",
      "NOTE:Karaca Hukuk & Danışmanlık Kurucu Avukatı",
      "END:VCARD"
    ].join("\r\n");
    ...
    link.href = url;
    link.setAttribute("download", "Av_Ismail_Karaca.vcf");
  ...
  return (
    <div className="card-page-wrapper">
      <style>{`
        .card-page-wrapper {
          min-height: 100vh;
          background: radial-gradient(circle at top, #0c2547 0%, #030a16 100%);
          display: flex;
          align-items: center;
        ...
        .card-container {
          ...
          max-width: 440px;
          padding: 2.5rem 2rem;
          box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 40px rgba(184, 145, 70, 0.1);
          text-align: center;
          position: relative;
          z-index: 10;
          display: flex;
        ...
        .logo-img {
          height: 50px;
          width: auto;
          filter: drop-shadow(0 2px 8px rgba(184, 145, 70, 0.2));
        ...
        .avatar-wrapper {
          ...
          border-radius: 50%;
          padding: 4px;
          background: linear-gradient(135deg, var(--color-accent) 0%, #ffffff 50%, var(--color-accent) 100%);
          box-shadow: 0 8px 25px rgba(184, 145, 70, 0.3);
          margin-top: 0.5rem;
        }
        .avatar-img {
          width: 100%;
        ...
        .lawyer-name {
          ...
          background: linear-gradient(135deg, #ffffff 40%, #f3e5ab 70%, #d4af37 100%);
        ...
        .btn-call:hover {
          background: #a37d35;
          transform: translateY(-3px);
          box-shadow: 0 8px 25px rgba(184, 145, 70, 0.4);
        }
        .btn-save {
        ...
        .btn-website:hover {
          ...
          transform: translateY(-3px);
          box-shadow: 0 8px 25px rgba(184, 145, 70, 0.2);
        }
        .areas-section {
          width: 100%;
      ...
      <StarryBackground count={40} color="rgba(184, 145, 70, 0.15)" drift={true} />

      <div className="card-container">
        <img src={logoImage} alt="Karaca Hukuk Logo" className="logo-img" />

        <div className="avatar-wrapper">
          <img src={ismailKaraca} alt="Av. İsmail Karaca" className="avatar-img" />
        </div>

        <div>
          <h1 className="lawyer-name">Av. İsmail Karaca</h1>
          <p className="lawyer-title" style={{ marginTop: "0.5rem" }}>Kurucu Avukat / Arabulucu</p>
        </div>

        <span className="bar-badge">Rize Barosu</span>

        <div className="action-buttons">
          <a
            href="https://api.whatsapp.com/send?phone=905337308053&text=Merhaba%20Av.%20İsmail%20Bey,%20kartvizitiniz%20üzerinden%20size%20ulaşıyorum."
            target="_blank"
            rel="noopener noreferrer"
            className="btn-card btn-whatsapp"
          >
          ...
          <a href="tel:+905337308053" className="btn-card btn-call">
          ...
          <button onClick={handleSaveContact} className="btn-card btn-save">
            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <a href="#home" className="btn-card btn-website">
            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="address-box">
          ...
          <p className="address-text">
            Çarşı Mah. Kazım Karabekir Cad. Kuyumcular Sk. Kutlu Han K:3 No:407 Merkez/RİZE
          </p>
          <a
          ...
          >
            Yol Tarifi Al <span style={{ fontSize: "1.1rem", lineHeight: "1" }}>→</span>
          </a>
        </div>

        <div className="areas-section">
          <p className="areas-title">Çalışma Alanları</p>
...
const App = () => {
  ...
  if (currentHash === "#kartvizit" || currentHash === "#qr") {
